...
export const processExpoVideoEvents = {
  onPlaybackStatusUpdate: (videoRef, status) => {
    ...
    videoRef._currentStatus = {
      ...status,
      uri: videoRef._currentStatus.uri
    };
  ...
  onPlayingChange: (videoRef, isPlaying) => {
    if (isPlaying) {
      triggerExpoVideoEvent(videoRef, 'play', {
        isPlaying
      });
      triggerExpoVideoEvent(videoRef, 'playing', {
        isPlaying
      });
    } else {
      triggerExpoVideoEvent(videoRef, 'pause', {
        isPlaying
      });
    }
  },
  onError: (videoRef, error) => {
    triggerExpoVideoEvent(videoRef, 'error', {
      error
    });
  },
  onEnd: (videoRef, data) => {
...
export const expoVideoPlayerAdapter = videoRef => ({
  ...
  getCurrentTime: () => {
    ...
    return ((_videoRef$_currentSta2 = videoRef._currentStatus) === null || _videoRef$_currentSta2 === void 0 ? void 0 : _videoRef$_currentSta2.currentTime) || 0;
  },
  getReadyState: () => {
  ...
  getDuration: () => {
    ...
    return ((_videoRef$_currentSta3 = videoRef._currentStatus) === null || _videoRef$_currentSta3 === void 0 ? void 0 : _videoRef$_currentSta3.duration) || 0;
  }
});
//# sourceMappingURL=expoVideoPlayerAdapter.js.map