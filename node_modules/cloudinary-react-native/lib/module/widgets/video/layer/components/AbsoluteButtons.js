...
export function AbsoluteButtons({
  ...
  absoluteButtonGroups.forEach(([position, {
    ...
    buttons.forEach((button, index) => {
      ...
      const spacingStyle = calculateButtonPosition(position, index, buttons.length, isLandscape, layoutDirection);
      ...
      renderedButtons.push(/*#__PURE__*/React.createElement(CustomButton, {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, onBack && backButtonPosition === ButtonPosition.SE && /*#__PURE__*/React.createElement(TouchableOpacity, {
    ...
    size: ICON_SIZES.top,
    color: "white"
  })), shareButtonPosition === ButtonPosition.SE && /*#__PURE__*/React.createElement(TouchableOpacity, {
    style: [responsiveStyles.topButton, responsiveStyles.buttonPositionSE],
    onPress: onShare
  }, /*#__PURE__*/React.createElement(Ionicons, {
    name: "share-outline",
