...
import { COLORS, BORDER_RADIUS, SHADOW_VALUES, TOP_BUTTON_SIZE, CENTER_PLAY_BUTTON_SIZE, BOTTOM_BUTTON_SIZE, SEEKBAR_HEIGHT, SEEKBAR_TRACK_HEIGHT, SEEKBAR_HANDLE_SIZE, LEGACY_TOP_PADDING_IOS, LEGACY_TOP_PADDING_ANDROID, SE_BUTTON_RIGHT_OFFSET } from './constants';
import { getTopPadding, getBottomControlsPadding, getSeekbarAlignmentOffset, getSEButtonBottomOffset } from './utils';
...
export const getResponsiveStyles = (isLandscape = false) => {
  ...
  return StyleSheet.create({
    ...
    buttonPositionE: {
      ...
      top: '50%',
      marginTop: -22,
      // Half of TOP_BUTTON_SIZE to center
      zIndex: 10
    },
    buttonPositionW: {
      position: 'absolute',
    ...
    seekbarHandle: {
      ...
      // Center within the 20px height
      marginLeft: -8,
      // Half of width to center properly
      shadowColor: '#000',
