...
exports.VideoOrientationManager = void 0;
...
class VideoOrientationManager {
  ...
  initialize(updateState) {
    ...
    this.orientationSubscription = _reactNative.Dimensions.addEventListener('change', ({
      window
    }) => {
      const {
        width,
...
exports.VideoOrientationManager = VideoOrientationManager;
